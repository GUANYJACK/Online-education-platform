...
exports.SOCRATIC_PROMPTS = void 0;
...
function getSystemPrompt(subject) {
    ...
    if (subjectLower.includes('science') || subjectLower.includes('physics') || subjectLower.includes('chemistry') || subjectLower.includes('biology')) {
        return exports.SOCRATIC_PROMPTS.science.content;
    }
    return exports.SOCRATIC_PROMPTS.default.content;
}
